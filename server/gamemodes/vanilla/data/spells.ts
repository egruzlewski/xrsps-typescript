...
const ENTRIES: SpellDataEntry[] = [
    ...
    },
    {
        ...
        castSpotAnim: 114,
        levelRequired: 7,
        experienceGained: 17.5,
        spellbook: "standard",
        category: "utility",
        runeCosts: [
            { runeId: 564, quantity: 1 },
            { runeId: 555, quantity: 1 },
        ],
    },
    {
    ...
    },
    {
        ...
        runeCosts: [
            { runeId: 564, quantity: 1 },
            { runeId: 557, quantity: 15 },
            { runeId: 555, quantity: 15 },
        ],
    },
    {
        id: 6567,
        ...
        runeCosts: [
            { runeId: 564, quantity: 1 },
            { runeId: 557, quantity: 20 },
            { runeId: 554, quantity: 20 },
        ],
    },
    {
        id: 19475,
        ...
        runeCosts: [
            { runeId: 564, quantity: 1 },
            { runeId: 566, quantity: 20 },
            { runeId: 565, quantity: 20 },
        ],
    },
    {
        id: 9001,
...
function getAlternateSpellNames(name: string): string[] {
    ...
    const knownAliases: Record<string, string[]> = {
        ...
        "Lvl-1 Enchant": ["Enchant Level 1", "Lvl-1 Enchant Jewellery"],
        "Lvl-2 Enchant": ["Enchant Level 2", "Lvl-2 Enchant Jewellery"],
        "Lvl-3 Enchant": ["Enchant Level 3", "Lvl-3 Enchant Jewellery"],
        "Lvl-4 Enchant": ["Enchant Level 4", "Lvl-4 Enchant Jewellery"],
        "Lvl-5 Enchant": ["Enchant Level 5", "Lvl-5 Enchant Jewellery"],
        "Lvl-6 Enchant": ["Enchant Level 6", "Lvl-6 Enchant Jewellery"],
        "Lvl-7 Enchant": ["Enchant Level 7", "Lvl-7 Enchant Jewellery"],
    };
