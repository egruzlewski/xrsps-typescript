...
- **Agility** — full Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap, dispenser tickets), Brimhaven Agility Arena (obstacle XP + dispenser Tag/Redeem tickets; no 1-minute rotation), Draynor Village rooftop (120/lap), Al Kharid rooftop (216/lap), Varrock rooftop (270/lap), Canifis rooftop (240/lap; Marks of Grace not spawned), Falador rooftop (586/lap; Marks of Grace not spawned), Seers' Village rooftop (570/lap; Marks of Grace not spawned), Pollnivneach rooftop (890/lap; Marks of Grace not spawned), Rellekka rooftop (780/lap; Marks of Grace not spawned), Ardougne rooftop (889/lap; Marks of Grace not spawned), Ape Atoll (580/lap; ninja/Kruk greegree; fail-proof), Werewolf Agility Course (730/lap with stick; fail-proof), Prifddinas Agility Course (1285.2/lap; portals/crystal shards not wired), Colossal Wyrm Agility Course (Varlamore; basic 633/lap at 50, advanced 1053.6/lap at 62; fail-proof; termites/Worm Tongue not wired), Shayzien Agility Course (Kourend; basic 153.5/lap at 1, advanced 507.5/lap at 45 with crossbow + mith grapple 9419; fail-proof; Marks of Grace not spawned), Penguin Agility Course (Iceberg; 540/lap at 30; clockwork suit 10595/10596; fail-proof; Larry tuxedo-time / Cold War lock not wired), Meiyerditch (5 XP per floor jump at 25 unboostable; fail-proof; sickle-logo shelves/washing line/hideout shortcuts not wired), Hallowed Sepulchre (floors 1–5 platforms/stairs/bridges; completion 500/850/1425/2625/5850; fail-proof; timer/coffers/shop skipped), and Agility Pyramid (level 30; rolling block 12 / ledge 52 / climbing rocks 0 XP + pyramid top; doorway 300+8×level capped 1,000; Simon Templeton 10,000 coins; fail-proof; stairs/gaps/planks skipped). Other courses still missing.
- **Runecraft** — F2P plus members ruins altars (Air–Body, Cosmic, Chaos, Nature, Law, Death, Blood, Wrath), walk-up Astral (Lunar Diplomacy is not registered, so no quest lock), walk-up Kourend Blood and Arceuus Soul (dark essence fragments; dense runestone Chip 8975/8977/8979; Dark Altar 27979 venerate; chisel blocks to fragments), combination runes (Mist–Lava; 50% bind per essence, 100% with a worn binding necklace 5521 that spends 1 of 16 charges per craft), tiara imbuing at those ruins altars, Abyss inner-ring entry (wilderness Mage of Zamorak teleport plus Air–Blood rifts; no Wrath rift), outer-ring obstacles (tendrils/rock/boil/eyes/gap/passage loc clicks; level 1 checks; teleport to inner ring), and essence pouches (small–giant plus colossal; fill/empty/check rune or pure essence; degrade on fill via equipment charges; Dark Mage 2583 repairs). Skulling skipped.
...
| **Gaps** | `MultiCombatZones`: TODO PvP world and Duel Arena. `PoisonVenomSystem.processTick` is an empty compatibility stub (real ticks on actor state). `DegradationSystem` crystal varbit TODO. Boss `defaultAttackExecution` hits the combat target via `dealDamage`; telegraph delay and extra AoE targets are still unwired (Mole dig, Zulrah snakelings, venom clouds, and phase forms are wired). |
| **Tests** | Many `combat-*.test.ts`, weapon specials, dragonfire, engagement, farcast, granite maul, ballista, claws, etc. [`giant-mole-dig.test.ts`](../server/tests/giant-mole-dig.test.ts), [`zulrah-snakeling.test.ts`](../server/tests/zulrah-snakeling.test.ts), [`zulrah-venom-cloud.test.ts`](../server/tests/zulrah-venom-cloud.test.ts), [`zulrah-phase-transform.test.ts`](../server/tests/zulrah-phase-transform.test.ts), [`boss-auto-attack-damage.test.ts`](../server/tests/boss-auto-attack-damage.test.ts). |
| **Next step** | PvP world flag if you need it; boss telegraph delay / extra AoE targets if you need them. |
...
Combat skills (Attack, Strength, Defence, Hitpoints, Ranged, Magic) are **engine combat**, not `skills/` folders. Charge Orb, Enchant Jewellery, Superheat Item, Bones to Bananas, and Low/High Alchemy are the Magic exceptions: [`skills/magic/`](../server/gamemodes/vanilla/skills/magic/).

| Skill | Status | Path | What exists | Next step |
| --- | --- | --- | --- | --- |
| Attack / Strength / Defence / Hitpoints / Ranged / Magic | Wired | combat engine + [`skills/magic/`](../server/gamemodes/vanilla/skills/magic/) | XP, styles, regen/boosts; Charge Water/Earth/Fire/Air Orb at obelisks 2151/2150/2153/2152 (unpowered 567 → 571/575/569/573); Enchant Lvl-1–7 jewellery (sapphire–onyx + zenyte; strung amulets; Lvl-1–3 also enchant silver opal/jade/topaz); Superheat Item (spell 9075; 4 fire + 1 nature; Magic 53 XP + Smithing bar XP from furnace recipes; iron 100%; iron+2 coal → steel); Bones to Bananas (spell 9001; 2 earth + 2 water + 1 nature; Magic 25 XP; converts bones/burnt/bat/big/wolf/jogre/monkey/bleached → bananas 1963; dragon/long/curved skipped); Low/High Alchemy (spells 9110/9111; 3/5 fire + 1 nature; Magic 31/65 XP; coins from highAlch/lowAlch or 60%/40% of item value; untradeables and coins rejected). [`magic-charge-orb.test.ts`](../server/tests/magic-charge-orb.test.ts), [`magic-enchant-jewellery.test.ts`](../server/tests/magic-enchant-jewellery.test.ts), [`magic-superheat-item.test.ts`](../server/tests/magic-superheat-item.test.ts), [`magic-bones-to-bananas.test.ts`](../server/tests/magic-bones-to-bananas.test.ts), [`magic-alchemy.test.ts`](../server/tests/magic-alchemy.test.ts) | Telekinetic Grab; Bones to Peaches (not stubbed; Mage Training Arena unlock) |
...
| Mining | Partial | [`skills/mining/`](../server/gamemodes/vanilla/skills/mining/) | Rock loc map, pickaxes, Arceuus dense runestone (Chip locs 8975/8977/8979 → depleted 8976/8978/8980; Mining+Crafting 38; pickaxe + chisel; 12 Mining + 8 Crafting XP; `ResourceNodeTracker`). [`mining-dense-essence.test.ts`](../server/tests/mining-dense-essence.test.ts) | Remaining rocks; per-player dense depletion / leave-mine randomize; Kourend diary double block |
| Herblore | Partial | clean / unf / finish / stamina | Data lists in `herblore/index.ts` | Missing potions |
| Agility | Partial | [`skills/agility/`](../server/gamemodes/vanilla/skills/agility/) | Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap; in-order rocks bonus; dispenser Tag/Redeem tickets), Brimhaven Agility Arena (clickable obstacles; dispenser Tag/Redeem tickets 29480 at 345 XP each; 1-minute rotation, entry fee, fails, Karamja gloves, and voucher shop not wired), Draynor Village rooftop (120/lap; in-order completion), Al Kharid rooftop (216/lap; level 20; in-order completion), Varrock rooftop (270/lap; level 30; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure), Canifis rooftop (240/lap; level 40; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure), Falador rooftop (586/lap; level 50; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure), Seers' Village rooftop (570/lap; level 60; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure; Kandarin hard extra edge XP not wired), and Pollnivneach rooftop (890/lap; level 70; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure; Desert hard extra drying-line XP not wired), Rellekka rooftop (780/lap; level 80; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure; Fremennik hard extra pile-of-fish XP not wired), Ardougne rooftop (889/lap; level 90; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure), Ape Atoll (580/lap; level 48 unboostable; in-order completion; ninja 4024/4025 or Kruk 19525 greegree equipped; Marks of Grace not spawned — no mark-spawn infrastructure; Monkey Madness I Chapter 2 lock not wired), Werewolf Agility Course (730/lap with stick; level 60; in-order completion; stick 4179 granted after pipe; Agility Trainer 5927 Give-Stick 380 XP; fail-proof deathslide; Marks of Grace / trapdoor / ring of charos / Creature of Fenkenstrain lock not wired), Prifddinas Agility Course (1285.2/lap; level 75; in-order completion; fail-proof; portal shortcuts and crystal shards not wired; Song of the Elves lock not wired), Colossal Wyrm Agility Course (basic 633/lap at 50, advanced 1053.6/lap at 62; in-order completion; fail-proof; auto-edge XP bundled; termites, blessed bone shards, Worm Tongue shop/unlock, and giant squirrel not wired), Shayzien Agility Course (Kourend; basic 153.5/lap at 1, advanced 507.5/lap at 45 with bronze+ crossbow and mith grapple 9419; in-order completion; fail-proof; Marks of Grace not spawned — no mark-spawn infrastructure; soldier lap-stats NPC and Kourend diary not wired), Penguin Agility Course (Iceberg; 540/lap at 30; in-order completion; fail-proof; clockwork suit 10595/10596 cape or inventory; crushers 856-859 walk-past NPCs, 55 XP on loc 21120; ice-slope cutscene skipped; Larry tuxedo-time / Cold War lock not wired), Meiyerditch (5 XP per Jump-to floorboard / Walk-across floor at 25 unboostable; fail-proof; Darkness of Hallowvale lock and sickle-logo shelves/washing line/hideout shortcuts not wired), Hallowed Sepulchre (Darkmeyer; floors 1–5 at 52/62/72/77/87 boostable; platforms 50/10/100, mid stairs 25, bridges 50/50/75/75/80, floor completion 500/850/1425/2625/5850 via stairs or Magical Obelisk 38451; fail-proof; timer, sealed stairs, loot coffers, Grand Hallowed Coffin, trap puzzles, hallowed marks shop, and Sins of the Father lock not wired), and Agility Pyramid (level 30; fail-proof; rolling block 12 / ledge 52 / climbing rocks 0 XP + pyramid top 6970; doorway lap bonus 300+8×base Agility capped 1,000; Simon Templeton 10,000 coins; stairs/gaps/planks/fail-to-lower-level skipped). Fail-proof. [`agility-gnome-course.test.ts`](../server/tests/agility-gnome-course.test.ts), [`agility-barbarian-course.test.ts`](../server/tests/agility-barbarian-course.test.ts), [`agility-wilderness-course.test.ts`](../server/tests/agility-wilderness-course.test.ts), [`agility-draynor-course.test.ts`](../server/tests/agility-draynor-course.test.ts), [`agility-alkharid-course.test.ts`](../server/tests/agility-alkharid-course.test.ts), [`agility-varrock-course.test.ts`](../server/tests/agility-varrock-course.test.ts), [`agility-canifis-course.test.ts`](../server/tests/agility-canifis-course.test.ts), [`agility-falador-course.test.ts`](../server/tests/agility-falador-course.test.ts), [`agility-seers-course.test.ts`](../server/tests/agility-seers-course.test.ts), [`agility-pollnivneach-course.test.ts`](../server/tests/agility-pollnivneach-course.test.ts), [`agility-rellekka-course.test.ts`](../server/tests/agility-rellekka-course.test.ts), [`agility-ardougne-course.test.ts`](../server/tests/agility-ardougne-course.test.ts), [`agility-ape-atoll-course.test.ts`](../server/tests/agility-ape-atoll-course.test.ts), [`agility-werewolf-course.test.ts`](../server/tests/agility-werewolf-course.test.ts), [`agility-prifddinas-course.test.ts`](../server/tests/agility-prifddinas-course.test.ts), [`agility-colossal-wyrm-course.test.ts`](../server/tests/agility-colossal-wyrm-course.test.ts), [`agility-shayzien-course.test.ts`](../server/tests/agility-shayzien-course.test.ts), [`agility-penguin-course.test.ts`](../server/tests/agility-penguin-course.test.ts), [`agility-dorgesh-kaan-course.test.ts`](../server/tests/agility-dorgesh-kaan-course.test.ts), [`agility-meiyerditch-course.test.ts`](../server/tests/agility-meiyerditch-course.test.ts), [`agility-sepulchre-course.test.ts`](../server/tests/agility-sepulchre-course.test.ts), [`agility-brimhaven-arena.test.ts`](../server/tests/agility-brimhaven-arena.test.ts), [`agility-pyramid-course.test.ts`](../server/tests/agility-pyramid-course.test.ts) | Remaining pyramid obstacles; advanced gnome/barbarian |
...
| [`BossCombatScript.ts`](../server/gamemodes/vanilla/combat/BossCombatScript.ts) | `dealDamage` hits the combat target; telegraph delay and extra AoE targets still unwired (Mole dig, snakelings, venom clouds, and Zulrah phase forms are wired) |
| [`agility/index.ts`](../server/gamemodes/vanilla/skills/agility/index.ts) | Pyramid stairs/gaps/planks; Brimhaven rotation/entry/fails; other agility courses |
...
4. **Boss scripts**: telegraph delay and extra AoE targets (Mole dig, snakelings, venom clouds, phase forms, and combat-target `dealDamage` are wired).
