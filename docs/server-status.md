...
Combat skills (Attack, Strength, Defence, Hitpoints, Ranged, Magic) are **engine combat**, not `skills/` folders. Charge Orb, Enchant Jewellery, Superheat Item, and Bones to Bananas are the Magic exceptions: [`skills/magic/`](../server/gamemodes/vanilla/skills/magic/).

| Skill | Status | Path | What exists | Next step |
| --- | --- | --- | --- | --- |
| Attack / Strength / Defence / Hitpoints / Ranged / Magic | Wired | combat engine + [`skills/magic/`](../server/gamemodes/vanilla/skills/magic/) | XP, styles, regen/boosts; Charge Water/Earth/Fire/Air Orb at obelisks 2151/2150/2153/2152 (unpowered 567 → 571/575/569/573); Enchant Lvl-1–7 jewellery (sapphire–onyx + zenyte; strung amulets; Lvl-1–3 also enchant silver opal/jade/topaz); Superheat Item (spell 9075; 4 fire + 1 nature; Magic 53 XP + Smithing bar XP from furnace recipes; iron 100%; iron+2 coal → steel); Bones to Bananas (spell 9001; 2 earth + 2 water + 1 nature; Magic 25 XP; converts bones/burnt/bat/big/wolf/jogre/monkey/bleached → bananas 1963; dragon/long/curved skipped). [`magic-charge-orb.test.ts`](../server/tests/magic-charge-orb.test.ts), [`magic-enchant-jewellery.test.ts`](../server/tests/magic-enchant-jewellery.test.ts), [`magic-superheat-item.test.ts`](../server/tests/magic-superheat-item.test.ts), [`magic-bones-to-bananas.test.ts`](../server/tests/magic-bones-to-bananas.test.ts) | Bones to Peaches (not stubbed; Mage Training Arena unlock) |
