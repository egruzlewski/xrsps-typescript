...
- **Agility** — full Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap, dispenser tickets), Draynor Village rooftop (120/lap), Al Kharid rooftop (216/lap), Varrock rooftop (270/lap), Canifis rooftop (240/lap; Marks of Grace not spawned), Falador rooftop (586/lap; Marks of Grace not spawned), Seers' Village rooftop (570/lap; Marks of Grace not spawned), and Pollnivneach rooftop (890/lap; Marks of Grace not spawned). Other rooftops and courses still missing.
...
| [`agility/index.ts`](../server/gamemodes/vanilla/skills/agility/index.ts) | Remaining rooftops (Rellekka onward) and other agility courses |
