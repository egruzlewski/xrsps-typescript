...
- **Agility** — full Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap, dispenser tickets), Draynor Village rooftop (120/lap), and Al Kharid rooftop (216/lap; Marks of Grace not spawned). Other rooftops and courses still missing.
- **Runecraft** — F2P plus members ruins altars (Air–Body, Cosmic, Chaos, Nature, Law, Death, Blood, Wrath), walk-up Astral (Lunar Diplomacy is not registered, so no quest lock), combination runes (Mist–Lava), and tiara imbuing at those ruins altars. Soul/Kourend and the Abyss are still missing.
- **Crafting** — flax, shearing, spinning, jewellery (gold/silver + gems), gem cutting, leather/dragonhide armour, pottery, glassblowing, battlestaves (charged orb + staff), weaving (loom: cloth/sack/basket/drift net/fabric bolts). Snakeskin, onyx/zenyte, and opal crush chance still missing. Charge Orb at obelisks is Magic and still a stub.
...
| Crafting | Partial | [`skills/crafting/`](../server/gamemodes/vanilla/skills/crafting/) | flax, shearing, spinning, jewellery (gold/silver + gems), gem cutting, leather/dragonhide armour, pottery, glassblowing, battlestaves (charged orb + staff), weaving (loom: cloth/sack/basket/drift net/fabric bolts). [`crafting-jewellery-leather.test.ts`](../server/tests/crafting-jewellery-leather.test.ts), [`crafting-pottery-glassblowing.test.ts`](../server/tests/crafting-pottery-glassblowing.test.ts), [`crafting-battlestaves.test.ts`](../server/tests/crafting-battlestaves.test.ts), [`crafting-weaving.test.ts`](../server/tests/crafting-weaving.test.ts) | Snakeskin, onyx/zenyte, opal crush chance. Charge Orb (Magic/obelisks) still stub |
...
| Agility | Partial | [`skills/agility/`](../server/gamemodes/vanilla/skills/agility/) | Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap; in-order rocks bonus; dispenser Tag/Redeem tickets), Draynor Village rooftop (120/lap; in-order completion), and Al Kharid rooftop (216/lap; level 20; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure). Fail-proof. [`agility-gnome-course.test.ts`](../server/tests/agility-gnome-course.test.ts), [`agility-barbarian-course.test.ts`](../server/tests/agility-barbarian-course.test.ts), [`agility-wilderness-course.test.ts`](../server/tests/agility-wilderness-course.test.ts), [`agility-draynor-course.test.ts`](../server/tests/agility-draynor-course.test.ts), [`agility-alkharid-course.test.ts`](../server/tests/agility-alkharid-course.test.ts) | Remaining rooftops (Varrock onward), other courses |
...
| Runecraft | Partial | [`skills/runecrafting/`](../server/gamemodes/vanilla/skills/runecrafting/) | F2P Air–Body plus members ruins altars (Cosmic, Chaos, Nature, Law, Death, Blood, Wrath; tiara/talisman enter, craft, portal exit). Walk-up Astral on Lunar Isle (loc 34771; pure essence; 2× at 82; no ruins/portal; Lunar Diplomacy not registered so craft is not quest-locked). Combination runes (Mist–Lava: opposing talisman/tiara + elemental runes + pure essence at the matching altar). Tiara imbuing (blank tiara + talisman) at ruins altars. [`runecrafting-f2p-altars.test.ts`](../server/tests/runecrafting-f2p-altars.test.ts), [`runecrafting-members-altars.test.ts`](../server/tests/runecrafting-members-altars.test.ts), [`runecrafting-astral-altar.test.ts`](../server/tests/runecrafting-astral-altar.test.ts), [`runecrafting-combination-runes.test.ts`](../server/tests/runecrafting-combination-runes.test.ts), [`runecrafting-tiara-imbue.test.ts`](../server/tests/runecrafting-tiara-imbue.test.ts) | Soul/Kourend, Abyss; Lunar Diplomacy quest lock; combination 50% fail / binding necklace / Magic Imbue |
...
| [`agility/index.ts`](../server/gamemodes/vanilla/skills/agility/index.ts) | Remaining rooftops (Varrock onward) and other agility courses |
...
2. Fill **skill holes you care about first** (Crafting still lacks snakeskin, onyx/zenyte, and opal crush chance; Charge Orb at obelisks is Magic and still a stub; Slayer/Hunter/Farming/Construction are absent).
