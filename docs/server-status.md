...
- **Agility** — full Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap, dispenser tickets), and Draynor Village rooftop (120/lap; Marks of Grace not spawned). Other rooftops and courses still missing.
...
| Agility | Partial | [`skills/agility/`](../server/gamemodes/vanilla/skills/agility/) | Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap; in-order rocks bonus; dispenser Tag/Redeem tickets), and Draynor Village rooftop (120/lap; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure). Fail-proof. [`agility-gnome-course.test.ts`](../server/tests/agility-gnome-course.test.ts), [`agility-barbarian-course.test.ts`](../server/tests/agility-barbarian-course.test.ts), [`agility-wilderness-course.test.ts`](../server/tests/agility-wilderness-course.test.ts), [`agility-draynor-course.test.ts`](../server/tests/agility-draynor-course.test.ts) | Remaining rooftops (Al Kharid onward), other courses |
...
| [`agility/index.ts`](../server/gamemodes/vanilla/skills/agility/index.ts) | Remaining rooftops (Al Kharid onward) and other agility courses |
