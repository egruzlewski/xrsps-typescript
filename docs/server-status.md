...
- **Agility** — full Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap, dispenser tickets), Draynor Village rooftop (120/lap), Al Kharid rooftop (216/lap), Varrock rooftop (270/lap), Canifis rooftop (240/lap; Marks of Grace not spawned), and Falador rooftop (586/lap; Marks of Grace not spawned). Other rooftops and courses still missing.
- **Runecraft** — F2P plus members ruins altars (Air–Body, Cosmic, Chaos, Nature, Law, Death, Blood, Wrath), walk-up Astral (Lunar Diplomacy is not registered, so no quest lock), walk-up Kourend Blood and Arceuus Soul (dark essence fragments; dense mine / Dark Altar / chisel skipped), combination runes (Mist–Lava; 50% bind per essence, 100% with a worn binding necklace 5521 that spends 1 of 16 charges per craft), tiara imbuing at those ruins altars, and Abyss inner-ring entry (wilderness Mage of Zamorak teleport plus Air–Blood rifts; no Wrath rift; pouches / outer obstacles / skulling skipped).
...
| Agility | Partial | [`skills/agility/`](../server/gamemodes/vanilla/skills/agility/) | Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap; in-order rocks bonus; dispenser Tag/Redeem tickets), Draynor Village rooftop (120/lap; in-order completion), Al Kharid rooftop (216/lap; level 20; in-order completion), Varrock rooftop (270/lap; level 30; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure), Canifis rooftop (240/lap; level 40; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure), and Falador rooftop (586/lap; level 50; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure). Fail-proof. [`agility-gnome-course.test.ts`](../server/tests/agility-gnome-course.test.ts), [`agility-barbarian-course.test.ts`](../server/tests/agility-barbarian-course.test.ts), [`agility-wilderness-course.test.ts`](../server/tests/agility-wilderness-course.test.ts), [`agility-draynor-course.test.ts`](../server/tests/agility-draynor-course.test.ts), [`agility-alkharid-course.test.ts`](../server/tests/agility-alkharid-course.test.ts), [`agility-varrock-course.test.ts`](../server/tests/agility-varrock-course.test.ts), [`agility-canifis-course.test.ts`](../server/tests/agility-canifis-course.test.ts), [`agility-falador-course.test.ts`](../server/tests/agility-falador-course.test.ts) | Remaining rooftops (Seers' Village onward), other courses |
...
| [`agility/index.ts`](../server/gamemodes/vanilla/skills/agility/index.ts) | Remaining rooftops (Seers' Village onward) and other agility courses |
