...
| Runecraft | Partial | [`skills/runecrafting/`](../server/gamemodes/vanilla/skills/runecrafting/) | F2P Air–Body plus members ruins altars (Cosmic, Chaos, Nature, Law, Death, Blood, Wrath; tiara/talisman enter, craft, portal exit). Walk-up Astral on Lunar Isle (loc 34771; pure essence; 2× at 82; no ruins/portal; Lunar Diplomacy not registered so craft is not quest-locked). Walk-up Kourend Blood (loc 27978; 23.8 XP; 77) and Arceuus Soul (loc 27980; 29.7 XP; 90) bind dark essence fragments (7938); no ruins/portal; no extra runes from level. Dense runestone mining, Dark Altar conversion, and chiseling blocks into fragments are not implemented — craft works if the player already has fragments. Combination runes (Mist–Lava: opposing talisman/tiara + elemental runes + pure essence at the matching altar). Tiara imbuing (blank tiara + talisman) at ruins altars. [`runecrafting-f2p-altars.test.ts`](../server/tests/runecrafting-f2p-altars.test.ts), [`runecrafting-members-altars.test.ts`](../server/tests/runecrafting-members-altars.test.ts), [`runecrafting-astral-altar.test.ts`](../server/tests/runecrafting-astral-altar.test.ts), [`runecrafting-kourend-altars.test.ts`](../server/tests/runecrafting-kourend-altars.test.ts), [`runecrafting-combination-runes.test.ts`](../server/tests/runecrafting-combination-runes.test.ts), [`runecrafting-tiara-imbue.test.ts`](../server/tests/runecrafting-tiara-imbue.test.ts) | Dense mine / Dark Altar / chisel; Abyss; Lunar Diplomacy quest lock; combination 50% fail / binding necklace / Magic Imbue |
