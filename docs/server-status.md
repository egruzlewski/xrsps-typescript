...
- **Agility** — full Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap, dispenser tickets), Brimhaven Agility Arena (obstacle XP + dispenser Tag/Redeem tickets; no 1-minute rotation), Draynor Village rooftop (120/lap), Al Kharid rooftop (216/lap), Varrock rooftop (270/lap), Canifis rooftop (240/lap; Marks of Grace not spawned), Falador rooftop (586/lap; Marks of Grace not spawned), Seers' Village rooftop (570/lap; Marks of Grace not spawned), Pollnivneach rooftop (890/lap; Marks of Grace not spawned), Rellekka rooftop (780/lap; Marks of Grace not spawned), and Agility Pyramid (level 30; rolling block 12 / ledge 52 / climbing rocks 0 XP + pyramid top; doorway 300+8×level capped 1,000; Simon Templeton 10,000 coins; fail-proof; stairs/gaps/planks skipped). Other rooftops and courses still missing.
...
| [`agility/index.ts`](../server/gamemodes/vanilla/skills/agility/index.ts) | Remaining rooftops (Rellekka onward); pyramid stairs/gaps/planks; Brimhaven rotation/entry/fails; other agility courses |
