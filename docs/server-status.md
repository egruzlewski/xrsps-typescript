...
| Agility | Partial | [`skills/agility/`](../server/gamemodes/vanilla/skills/agility/) | Gnome Stronghold (110.5/lap), Barbarian Outpost (153.3 Agility + 41.3 Strength/lap), Wilderness (571.4/lap; in-order rocks bonus; dispenser Tag/Redeem tickets), Draynor Village rooftop (120/lap; in-order completion), Al Kharid rooftop (216/lap; level 20; in-order completion), and Varrock rooftop (270/lap; level 30; in-order completion; Marks of Grace not spawned — no mark-spawn infrastructure). Fail-proof. [`agility-gnome-course.test.ts`](../server/tests/agility-gnome-course.test.ts), [`agility-barbarian-course.test.ts`](../server/tests/agility-barbarian-course.test.ts), [`agility-wilderness-course.test.ts`](../server/tests/agility-wilderness-course.test.ts), [`agility-draynor-course.test.ts`](../server/tests/agility-draynor-course.test.ts), [`agility-alkharid-course.test.ts`](../server/tests/agility-alkharid-course.test.ts), [`agility-varrock-course.test.ts`](../server/tests/agility-varrock-course.test.ts) | Remaining rooftops (Canifis onward), other courses |
...
| [`agility/index.ts`](../server/gamemodes/vanilla/skills/agility/index.ts) | Remaining rooftops (Canifis onward) and other agility courses |
