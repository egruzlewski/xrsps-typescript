...
- **Runecraft** — F2P plus members ruins altars (Air–Body, Cosmic, Chaos, Nature, Law, Death, Blood, Wrath), combination runes (Mist–Lava), and tiara imbuing at those altars. Astral/Soul/Kourend and the Abyss are still missing.
...
| Runecraft | Partial | [`skills/runecrafting/`](../server/gamemodes/vanilla/skills/runecrafting/) | F2P Air–Body plus members ruins altars (Cosmic, Chaos, Nature, Law, Death, Blood, Wrath; tiara/talisman enter, craft, portal exit). Combination runes (Mist–Lava: opposing talisman/tiara + elemental runes + pure essence at the matching altar). Tiara imbuing (blank tiara + talisman). [`runecrafting-f2p-altars.test.ts`](../server/tests/runecrafting-f2p-altars.test.ts), [`runecrafting-members-altars.test.ts`](../server/tests/runecrafting-members-altars.test.ts), [`runecrafting-combination-runes.test.ts`](../server/tests/runecrafting-combination-runes.test.ts), [`runecrafting-tiara-imbue.test.ts`](../server/tests/runecrafting-tiara-imbue.test.ts) | Astral/Soul/Kourend, Abyss; combination 50% fail / binding necklace / Magic Imbue |
